...
public class KnnBelief implements SensorBeliefModel<Double> {
    ...
    private final List<SensorValue> points;
    ...
    private List<SensorValue> knn(double value) {
    ...
    private MassFunction getMassFunction(double value, SensorValue point) {
    ...
    public MassFunction toMass(Double sensorValue) {
        List<SensorValue> knn = knn(sensorValue);
