...
public class SpecificityModelTest {
    ...
    private SpecificitySensorBeliefModel<Double> specificityModel;
    ...
    public void sensorModelWithTemporization_newEvidenceMoreSpecific_ReturnsTheSameAsUnderlyingModel() {
        specificityModel.toMass(100.0, 0);//first call
        assertEquals(specificityModel.toMass(100.0), specificityModel.toMass(100.0, 0.5));
    }

    @Test
    public void sensorModelWithTemporization_newEvidenceLessSpecific_ReturnsTheSameAsUnderlyingModel() {
        specificityModel.toMass(150.0, 0);//first call
        ...
        assertEquals(expected, specificityModel.toMass(300.0, 0.5));
    }
