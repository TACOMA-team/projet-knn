 ...
 */
public class FusionSensorBeliefModel implements TimeDependentSensorBeliefModel {
     ...
     */
    public FusionSensorBeliefModel(SensorBeliefModel underlyingModel, double maxTime) {
    ...
    @Override
    public MassFunction toMass(double sensorValue, double elapsedTime) {
