...
/**
 * Simple sensor model wich generates mass function from sensor values with
 * a linear interpolation between mass functions.
 *
 ...
 * {{A}-> 0.4, {A,B} -> 0.6}.
 */
public class LinearSensorBeliefModel implements SensorBeliefModel {
